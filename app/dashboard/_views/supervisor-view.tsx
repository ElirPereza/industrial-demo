		...
		<div className="flex flex-1 flex-col gap-6 p-4 pt-0">
				...
				<div className="grid grid-cols-1 gap-px rounded-xl bg-border sm:grid-cols-2 lg:grid-cols-4">
					{[
						...
						},
						{
							...
							icon: <Users className="size-4 text-blue-600" weight="duotone" />,
			...
			<div className="grid gap-6 lg:grid-cols-3">
				...
				<Card className="lg:col-span-2">
					<CardHeader>
						...
						<CardDescription>Métricas de desempeño por técnico</CardDescription>
					</CardHeader>
					<CardContent>
			...
			<div className="grid gap-6 lg:grid-cols-2">
				...
				<Card>
					<CardHeader>
						<CardTitle className="flex items-center gap-2">
							<ShieldCheck className="size-5 text-amber-600" weight="duotone" />
									...
									return (
										...
										>
											<div className="min-w-0 flex-1">
												...
												<p className="text-xs text-muted-foreground">
													{equipo?.nombre} &bull; {ot.tecnicoAsignado} &bull;{" "}
