...
// Work orders assigned to this contractor (simulated)
const otContratista = [
					...
					<div className="flex items-center gap-2 px-4">
						...
						<Breadcrumb>
							<BreadcrumbList>
								...
								<BreadcrumbItem>
									<BreadcrumbPage>Portal Contratista</BreadcrumbPage>
								</BreadcrumbItem>
							</BreadcrumbList>
						</Breadcrumb>
					</div>
						...
						{[
							{
								...
								icon: (
									<Wrench className="size-4 text-blue-600" weight="duotone" />
								),
							...
							},
							{
								...
								icon: (
									<Clock className="size-4 text-violet-600" weight="duotone" />
								),
											...
											return (
												<tr key={ot.id}>
													...
													<td className="py-3 text-muted-foreground tabular-nums">
														{ot.fechaInicioProgramada?.toLocaleDateString(
															"es-ES",
															{
																day: "2-digit",
																month: "short",
					...
					<div className="grid gap-6 lg:grid-cols-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Registro de horas del mes actual
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="overflow-x-auto">
