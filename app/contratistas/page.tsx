...
export default function ContratistasPage() {
	...
	if (isLoading) return <PageLoading message="Cargando contratistas..." />
	if (error) {
		return (
			<PageError
	...
	const contratistas = (data ?? []).filter((u) => u.rol === "contratista")
					...
					<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							<CardContent className="flex items-center gap-4 p-4">
								...
								<div>
									<p className="text-2xl font-semibold">N/D</p>
									<p className="text-sm text-muted-foreground">
										Calificación Prom.
									</p>
								</div>
